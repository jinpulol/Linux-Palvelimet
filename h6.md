...
- Uuden mallin lisääminen tapahtuu muokkaamalla crm-hakemistossa olevaa ``models.py``-tiedostoa:
  ...
  -     from django.db import models
        ...
        ## PALAUTUKSEN JÄLKEINEN EDIT: LISÄÄ NÄMÄ TIETOKANNAN REKISTERÖINNIN JÄLKEEN!
        def __str__(self):    # nämä kaksi viimeistä riviä muuttavat attribuutin merkkijonoksi
