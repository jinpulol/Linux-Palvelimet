...
Käynnistin Debian-Linux-palvelimet -virtuaalikoneen ja valitsin ns. bootloaderista ylimmän vaihtoehdon "Live system (amd64)". Tässä kohtaa tietokoneeni mietti jokusen sekunnin, kunnes Debianin työpöytä aukesi eteeni. Työpöydän auettua testasin selaimella, että netti toimii - ja kyllähän se toimi.
